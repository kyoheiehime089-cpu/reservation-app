...
- お客様が第1〜第3希望日時を選んで予約リクエストを送信できます。
- 名前、電話番号、メールアドレス、連絡事項を入力できます。
- 予約リクエスト完了画面を表示します。
...
1. 予約フォームを開きます。
2. 第1希望、第2希望、第3希望の日時を選びます。
3. 名前、電話番号、メールアドレス、必要に応じて連絡事項を入力します。
4. 「予約を確定する」を押します。
...
1. `/admin.html` を開きます。
2. 「予約一覧」で、送信日時、名前、メールアドレス、電話番号、第1希望日時を一覧確認できます。
